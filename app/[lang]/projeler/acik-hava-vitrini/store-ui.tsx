      ...
      <div className="flex flex-col gap-4 px-4 py-4 md:px-6 lg:px-8">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex items-center justify-between gap-4">
            <Link
              href={`/${lang}/projeler`}
              className="inline-flex items-center gap-2 border border-white/10 bg-white/[0.04] px-4 py-2 text-xs uppercase tracking-[0.16em] text-white/60 transition hover:border-white/20 hover:bg-white/[0.07] hover:text-white"
            >
              <span>←</span>
              <span>Projeler</span>
            </Link>
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-8">
            <Link
              href={basePath}
              className="text-2xl tracking-[0.32em] text-white"
          ...
          <div className="flex items-center gap-3 self-start xl:self-auto">
            <Link
              ...
              className="inline-flex items-center gap-3 border border-white/10 bg-white/[0.04] px-4 py-2 text-xs uppercase tracking-[0.16em] text-white/70 transition hover:border-white/20 hover:bg-white/[0.07] hover:text-white"
            >
              <span>Sepet</span>
              <span className="inline-flex h-5 min-w-5 items-center justify-center bg-white px-1.5 text-[0.6rem] font-bold text-[#080808]">
                {itemCount}
              </span>
            </Link>
            <Link href={getStoreCheckoutPath(lang)} className={primaryButtonClass}>
