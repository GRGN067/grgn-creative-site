      ...
      >
        ...
        <div className="relative z-10 mx-auto flex min-h-[100dvh] max-w-[1400px] flex-col px-5 pt-5 sm:px-6 md:px-8 lg:px-6 lg:pt-6">
          ...
          <div className="hidden justify-center lg:flex">
            <div className="flex h-[58px] w-[1020px] items-center rounded-full border border-white/20 bg-white/[0.05] px-8 shadow-[0_0_35px_rgba(255,255,255,0.08)] backdrop-blur-xl">
              <div className="flex w-full items-center justify-between gap-8">
                ...
                <nav className="flex items-center gap-10 text-[15px] font-medium text-white/85">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl">
          <Reveal>
            <div className="mb-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
              <h2 className="text-center text-4xl font-semibold tracking-tight sm:text-5xl md:text-left">
                {t.services_title}
              </h2>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <Reveal delay={0}>
              <ServiceCard
                ...
                href={`/${lang}/hizmetler/kurumsal-kimlik`}
              />
            </Reveal>
            ...
            <Reveal delay={120}>
              <ServiceCard
                ...
                href={`/${lang}/hizmetler/sosyal-medya-tasarimi`}
              />
            </Reveal>
            ...
            <Reveal delay={220}>
              <ServiceCard
                ...
                href={`/${lang}/hizmetler/ambalaj-tasarimi`}
              />
            </Reveal>
            ...
            <Reveal delay={320}>
              <ServiceCard
                ...
                href={`/${lang}/hizmetler/web-tasarim`}
              />
            </Reveal>
          </div>
