            ...
            <div className="h-[80px] w-full max-w-[900px] rounded-full border border-white/20 bg-white/[0.04] px-8 shadow-[0_0_40px_rgba(255,255,255,0.06)] backdrop-blur-xl">
              <div className="flex h-full items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="https://wa.me/905301159374?text=Merhaba%2C%20web%20tasar%C4%B1m%20hizmetiniz%20i%C3%A7in%20ula%C5%9F%C4%B1yorum."
                    target="_blank"
                    rel="noreferrer"
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <Reveal delay={160}>
              <p className="mt-6 max-w-4xl text-base leading-7 text-zinc-300 sm:text-lg sm:leading-8 md:mt-8 md:text-[23px] md:leading-10">
                GRGN Creative olarak markalar için modern, premium ve güçlü
                görünen web deneyimleri tasarlıyoruz. Amacımız sadece estetik bir
                site kurmak değil; markayı daha net anlatan, güven veren ve
                ziyaretçiyi doğru aksiyona yönlendiren dijital bir yapı
                oluşturmaktır.
              </p>
            </Reveal>
            ...
            <Reveal>
              <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-8 md:p-10">
                ...
                <div className="mt-6 space-y-4 text-sm leading-7 text-zinc-300 sm:mt-8 sm:space-y-5 sm:text-base sm:leading-8">
                  <p>Markaya uygun arayüz tasarımı</p>
                  <p>Kullanıcı deneyimi kurgusu</p>
                  <p>Mobil uyumlu modern sayfa yapıları</p>
                  <p>Hizmetleri net anlatan içerik akışı</p>
                  <p>Dönüşüm odaklı CTA ve iletişim yapısı</p>
                  <p>Premium görünümle güven veren dijital vitrin</p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={120}>
              <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-8 md:p-10">
                ...
                <p className="mt-6 text-base leading-7 text-zinc-300 sm:mt-8 sm:text-lg sm:leading-8">
                  Daha profesyonel görünmek isteyen, dijitalde dağınık değil
                  güçlü bir marka algısı oluşturmak isteyen ve ziyaretçisini
                  müşteriye dönüştürmek isteyen markalar için uygundur.
                </p>

                <div className="mt-8 h-px w-20 bg-white/10" />

                <p className="mt-8 text-sm leading-7 text-zinc-400 sm:text-base sm:leading-8">
                  Yeni kurulan markalar, kurumsal görünümünü güçlendirmek isteyen
                  işletmeler, yaratıcı stüdyolar, butik markalar ve premium
                  hizmet sunan firmalar için özellikle etkili bir çözümdür.
                </p>
              </div>
            </Reveal>
          </div>
        ...
        <section className="px-5 py-10 sm:px-6 md:px-10 md:py-16">
          <div className="mx-auto max-w-7xl">
            <Reveal>
              <div className="mb-10">
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl md:text-6xl">
                  İyi görünen değil, doğru çalışan bir web yapısı.
                </h2>
              </div>
            </Reveal>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Reveal delay={0}>
                <InfoCard
                  title="İlk izlenimi güçlendirir"
                  text="Kullanıcı markanı ilk birkaç saniyede değerlendirir. Güçlü bir arayüz bu algıyı doğrudan etkiler."
                />
              </Reveal>

              <Reveal delay={120}>
                <InfoCard
                  title="Hizmeti net anlatır"
                  text="Dağınık içerik yerine stratejik bir sayfa akışı, ziyaretçinin ne sunduğunu hızlıca anlamasını sağlar."
                />
              </Reveal>

              <Reveal delay={240}>
                <InfoCard
                  title="Dönüşümü artırır"
                  text="İletişim, teklif alma ve proje başlatma gibi aksiyonlar doğru CTA yapısıyla daha güçlü hale gelir."
                />
              </Reveal>
            </div>
          </div>
              ...
              <div className="rounded-[34px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-8 md:p-12">
                ...
                <div className="mt-10 grid gap-8 sm:grid-cols-2 md:grid-cols-4">
                  <ProcessItem
                    number="01"
                    title="Analiz"
                    text="Marka, hedef kitle ve ihtiyaç belirlenir."
                  />
                  <ProcessItem
                    number="02"
                    title="Yapı"
                    text="Sayfa akışı ve içerik yapısı planlanır."
                  />
                  <ProcessItem
                    number="03"
                    title="Tasarım"
                    text="Premium görsel dil ile arayüz hazırlanır."
                  />
                  <ProcessItem
                    number="04"
                    title="Teslim"
                    text="Son düzenlemelerle birlikte yayın sürecine geçilir."
                  />
                </div>
              </div>
            </Reveal>
          ...
          <div className="mx-auto max-w-7xl">
            <Reveal>
              <div className="mb-10">
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl md:text-6xl">
                  Bu hizmetin sonunda ne elde edersin?
                </h2>
              </div>
            </Reveal>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Reveal delay={0}>
                <InfoCard
                  title="Daha premium bir marka algısı"
                  text="Markanın dijitalde daha güvenilir, daha modern ve daha güçlü görünmesini sağlayan bir yapı."
                />
              </Reveal>

              <Reveal delay={100}>
                <InfoCard
                  title="Daha net hizmet anlatımı"
                  text="Kullanıcının kaybolmadan markayı, hizmetleri ve iletişim yolunu anlaması."
                />
              </Reveal>
              ...
              <Reveal delay={200}>
                <InfoCard
                  ...
                  text="Mobil uyumlu, dengeli ve akışkan bir sayfa yapısı ile ziyaretçinin sitede kalma süresinin artması."
                />
              </Reveal>

              <Reveal delay={300}>
                <InfoCard
                  title="Daha güçlü dönüşüm potansiyeli"
                  text="Doğru içerik akışı ve net CTA kullanımı ile ziyaretçinin aksiyona geçmesinin kolaylaşması."
                />
              </Reveal>
            </div>
          </div>
            ...
            <Reveal>
              <div className="rounded-[36px] border border-white/10 bg-white/[0.04] p-7 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-10 md:p-14">
                ...
                <p className="mt-6 max-w-2xl text-base leading-7 text-zinc-400 sm:text-lg sm:leading-8">
                  Eğer sen de markan için güçlü bir ilk izlenim, net bir hizmet
                  anlatımı ve premium bir dijital görünüm istiyorsan bizimle
