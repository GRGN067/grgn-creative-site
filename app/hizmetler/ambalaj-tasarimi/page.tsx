            ...
            <div className="h-[80px] w-full max-w-[900px] rounded-full border border-white/20 bg-white/[0.04] px-8 shadow-[0_0_40px_rgba(255,255,255,0.06)] backdrop-blur-xl">
              <div className="flex h-full items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="https://wa.me/905301159374?text=Merhaba%2C%20ambalaj%20tasar%C4%B1m%C4%B1%20hizmetiniz%20i%C3%A7in%20ula%C5%9F%C4%B1yorum."
                    target="_blank"
                    rel="noreferrer"
      ...
      <div className="relative z-10">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <Reveal delay={160}>
              <p className="mt-6 max-w-4xl text-base leading-7 text-zinc-300 sm:text-lg sm:leading-8 md:mt-8 md:text-[23px] md:leading-10">
                GRGN Creative olarak ürünlerin rafta daha güçlü görünmesini,
                daha net algılanmasını ve marka değerini daha doğru yansıtmasını
                sağlayan ambalaj tasarımları oluşturuyoruz. Ambalajı yalnızca bir
                yüzey olarak değil, markanın ilk satış alanı olarak ele alıyoruz.
              </p>
            </Reveal>
        ...
        <section className="px-5 py-10 sm:px-6 md:px-10 md:py-16">
          <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-2">
            <Reveal>
              <ContentCard
                title="Ürünün ilk izlenimi"
                text="Ambalaj, ürünle kurulan ilk görsel temastır. Bu yüzden yalnızca estetik değil; güven, kalite algısı ve dikkat çekicilik açısından da kritik bir rol oynar. Doğru ambalaj, ürünü rafta görünür ve akılda kalıcı hale getirir."
              />
            </Reveal>
            ...
            <Reveal delay={120}>
              <ContentCard
                title="Ne sağlıyoruz?"
                text="Ürünün kategorisine, hedef kitlesine ve marka konumuna uygun bir ambalaj dili oluşturuyoruz. Böylece ürün yalnızca iyi görünmez; daha doğru algılanır, daha ayırt edilebilir olur ve markanın bütünlüğünü taşır."
              />
            </Reveal>
          </div>
        </section>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Reveal delay={0}>
                <InfoCard
                  ...
                  text="Ürün bulunduğu kategoride daha görünür, daha ayırt edilebilir ve daha dikkat çekici hale gelir."
                />
              </Reveal>

              <Reveal delay={120}>
                <InfoCard
                  title="Daha premium algı"
                  text="Ambalaj, ürünün daha kaliteli ve daha güvenilir görünmesini sağlayan önemli bir algı katmanı oluşturur."
                />
              </Reveal>
              ...
              <Reveal delay={240}>
                <InfoCard
                  title="Marka uyumu"
                  text="Ürün tasarımı, markanın genel görsel diliyle uyumlu çalışır ve dağınık değil bütünlüklü bir görünüm sağlar."
                />
              </Reveal>
            </div>
          </div>
            ...
            <Reveal>
              <div className="rounded-[34px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-8 md:p-12">
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
                  Ambalaj tasarımında neyi kuruyoruz?
                </h2>

                <div className="mt-10 grid gap-8 sm:grid-cols-2 md:grid-cols-4">
                  <ProcessItem
                    number="01"
                    title="Ön Yüz Kurgusu"
                    text="Ürünün ilk bakışta ne söylediği, nasıl dikkat çektiği ve nasıl algılandığı planlanır."
                  />
                  <ProcessItem
                    number="02"
                    title="Tipografi Sistemi"
                    text="Ürünün okunabilirliğini ve raf üzerindeki etkisini güçlendiren yazı düzeni kurulur."
                  />
                  <ProcessItem
                    number="03"
                    title="Renk ve Doku"
                    text="Marka karakterini ve ürün hissini destekleyen görsel yüzey dili oluşturulur."
                  />
                  <ProcessItem
                    number="04"
                    title="Genel Kompozisyon"
                    text="Tüm ambalaj yüzeyi dengeli, güçlü ve ticari açıdan etkili bir düzene oturtulur."
                  />
                </div>
              </div>
            </Reveal>
          ...
          <div className="mx-auto max-w-7xl">
            <Reveal>
              <div className="mb-10">
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl md:text-6xl">
                  Ürününün görünümünü ciddiye alan markalar için.
                </h2>
              </div>
            </Reveal>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Reveal delay={0}>
                <InfoCard
                  title="Yeni ürün çıkaran markalar"
                  text="Lansman aşamasında ürününü güçlü bir ilk izlenimle sunmak isteyen markalar için."
                />
              </Reveal>

              <Reveal delay={100}>
                <InfoCard
                  title="Mevcut ürününü yenilemek isteyenler"
                  text="Daha güncel, daha premium ve daha ticari bir görünüm isteyen markalar için."
                />
              </Reveal>

              <Reveal delay={200}>
                <InfoCard
                  title="Butik ve premium üreticiler"
                  text="Küçük ölçekte ama güçlü görünmek isteyen, detayla fark yaratmak isteyen markalar için."
                />
              </Reveal>

              <Reveal delay={300}>
                <InfoCard
                  title="Raf rekabetinde öne çıkmak isteyenler"
                  text="Benzer ürünler arasından daha net ayrışmak ve görünürlüğünü artırmak isteyenler için."
                />
              </Reveal>
            </div>
          </div>
            ...
            <Reveal>
              <div className="rounded-[36px] border border-white/10 bg-white/[0.04] p-7 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-10 md:p-14">
                ...
                <h2 className="mt-4 max-w-3xl text-3xl font-semibold tracking-tight sm:text-4xl md:text-6xl">
                  Ürünün için daha güçlü bir ambalaj görünümü oluşturalım.
                </h2>

                <p className="mt-6 max-w-2xl text-base leading-7 text-zinc-400 sm:text-lg sm:leading-8">
                  Eğer ürününün daha dikkat çekici, daha premium ve daha güçlü
