            ...
            <div className="h-[80px] w-full max-w-[900px] rounded-full border border-white/20 bg-white/[0.04] px-8 shadow-[0_0_40px_rgba(255,255,255,0.06)] backdrop-blur-xl">
              <div className="flex h-full items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    href="https://wa.me/905301159374?text=Merhaba%2C%20sosyal%20medya%20tasar%C4%B1m%C4%B1%20hizmetiniz%20i%C3%A7in%20ula%C5%9F%C4%B1yorum."
                    target="_blank"
                    rel="noreferrer"
      ...
      <div className="relative z-10">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <Reveal delay={160}>
              <p className="mt-6 max-w-4xl text-base leading-7 text-zinc-300 sm:text-lg sm:leading-8 md:mt-8 md:text-[23px] md:leading-10">
                GRGN Creative olarak markaların sosyal medyada daha güçlü,
                daha tutarlı ve daha premium görünmesini sağlayan tasarım
                sistemleri kuruyoruz. Amacımız sadece gönderi hazırlamak değil;
                markanın dijitalde tek çizgide algılanmasını sağlayan güçlü bir
                görsel dil oluşturmaktır.
              </p>
            </Reveal>
        ...
        <section className="px-5 py-10 sm:px-6 md:px-10 md:py-16">
          <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-2">
            <Reveal>
              <ContentCard
                title="Markanın dijital vitrini"
                text="Sosyal medya bugün birçok marka için ilk temas noktasıdır. Bu yüzden görsel kalite, düzen ve tutarlılık yalnızca estetik değil; doğrudan güven, kalite algısı ve marka değeri üretir."
              />
            </Reveal>
            ...
            <Reveal delay={120}>
              <ContentCard
                title="Ne sağlıyoruz?"
                text="Markanın sektörüne, hedef kitlesine ve konumuna uygun bir sosyal medya tasarım dili kuruyoruz. Böylece paylaşımlar rastgele görünmek yerine bir sistemin parçası haline gelir ve marka daha profesyonel algılanır."
              />
            </Reveal>
          </div>
        </section>
            ...
            <Reveal>
              <div className="mb-10">
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl md:text-6xl">
                  Güçlü, düzenli ve tanınabilir bir sosyal medya dili.
                </h2>
              </div>
            </Reveal>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <Reveal delay={0}>
                <InfoCard
                  ...
                  text="Post, story ve kampanya görselleri arasında görsel bütünlük kurulur."
                />
              </Reveal>
              ...
              <Reveal delay={120}>
                <InfoCard
                  ...
                  text="Marka daha düzenli, daha kaliteli ve daha güven veren bir görünüm kazanır."
                />
              </Reveal>

              <Reveal delay={240}>
                <InfoCard
                  title="Daha net iletişim"
                  text="Mesajlar karışık değil, daha okunur ve daha etkili biçimde sunulur."
                />
              </Reveal>
            </div>
          </div>
            ...
            <Reveal>
              <div className="rounded-[34px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-8 md:p-12">
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl">
                  Sosyal medyada neyi tasarlıyoruz?
                </h2>
                ...
                <div className="mt-10 grid gap-8 sm:grid-cols-2 md:grid-cols-4">
                  <ProcessItem
                    ...
                    text="Marka estetiğine uygun sabit gönderi görselleri hazırlanır."
                  />
                  <ProcessItem
                    number="02"
                    title="Story Dili"
                    text="Günlük iletişim için daha hızlı ama tutarlı story yapıları kurulur."
                  />
                  <ProcessItem
                    number="03"
                    title="Kampanya Görselleri"
                    text="Duyuru, satış ve lansman içerikleri için dikkat çekici görsel sistem tasarlanır."
                  />
                  <ProcessItem
                    number="04"
                    title="Şablon Mantığı"
                    text="Markanın içerik üretimini kolaylaştıracak tekrar edilebilir tasarım altyapısı kurulur."
                  />
                </div>
              </div>
            </Reveal>
          ...
          <div className="mx-auto max-w-7xl">
            <Reveal>
              <div className="mb-10">
                ...
                <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl md:text-6xl">
                  Sosyal medya görünümünü ciddiye alan markalar için.
                </h2>
              </div>
            </Reveal>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <Reveal delay={0}>
                <InfoCard
                  title="Yeni başlayan markalar"
                  text="İlk günden dağınık değil, düzenli ve profesyonel bir görünüm oluşturmak isteyen markalar için."
                />
              </Reveal>

              <Reveal delay={100}>
                <InfoCard
                  title="Mevcut görünümünü güçlendirmek isteyen işletmeler"
                  text="Sosyal medyada daha kurumsal, daha premium ve daha güvenilir görünmek isteyen işletmeler için."
                />
              </Reveal>

              <Reveal delay={200}>
                <InfoCard
                  title="Satış odaklı sayfalar"
                  text="Kampanya, ürün ve hizmet iletişimini daha güçlü göstermek isteyen markalar için."
                />
              </Reveal>

              <Reveal delay={300}>
                <InfoCard
                  title="Kategorisinde öne çıkmak isteyenler"
                  text="Rakiplerinden daha güçlü görünmek ve dijitalde daha ayırt edilebilir olmak isteyen markalar için."
                />
              </Reveal>
            </div>
          </div>
            ...
            <Reveal>
              <div className="rounded-[36px] border border-white/10 bg-white/[0.04] p-7 shadow-[0_0_40px_rgba(255,255,255,0.03)] backdrop-blur-sm sm:p-10 md:p-14">
                ...
                <h2 className="mt-4 max-w-3xl text-3xl font-semibold tracking-tight sm:text-4xl md:text-6xl">
                  Markan için daha güçlü bir sosyal medya görünümü kuralım.
                </h2>

                <p className="mt-6 max-w-2xl text-base leading-7 text-zinc-400 sm:text-lg sm:leading-8">
                  Eğer markanın sosyal medyada daha tutarlı, daha kaliteli ve
                  daha profesyonel görünmesini istiyorsan bizimle iletişime
                  geçebilirsin.
                </p>
